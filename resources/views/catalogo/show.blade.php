  ...
  <div class="row g-5">
    ...
    <div class="col-lg-6 info-side fade-up fade-up-2">
      ...
      <div class="obra-artist-row">
        <img src="{{ asset($obra->artista->image_url) }}" class="artist-avatar" alt="{{ $obra->artista->nombre }}" />
        <div>
  ...
  <div class="row g-4">
    @forelse($obrasRelacionadas as $rel)
      <div class="col-6 col-lg-3 fade-up fade-up-1">
        <div class="rel-card">
          <img src="{{ asset($rel->image_url) }}" alt="{{ $rel->titulo }}" />
          <div class="rel-card-body">
            <div class="rel-title">{{ $rel->titulo }}</div>
            <a href="{{ route('obra.detalle', $rel->id) }}" class="rel-artist">{{ $rel->artista->nombre }}</a>
...
<div id="zoomModal"
  ...
  <img id="zoomImg" src="{{ asset($obra->image_url) }}"
