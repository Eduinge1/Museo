  ...
  <div class="validation-card">
    ...
    <div class="main-form" id="mainForm">
      ...
      <form method="POST"
        ...
        {{-- Input único para código --}}
        <p class="otp-label">Código de seguridad</p>
        <div class="mb-4">
          <input class="form-control text-center py-3 fw-bold" 
                 type="text" 
                 name="codigo_seguridad" 
                 id="codigoCompleto" 
                 placeholder="MUS-XXXX-XXXX-XXXX" 
                 style="font-size: 1.4rem; letter-spacing: 2px; border-radius: 15px; border: 2px solid #ddd;"
                 required />
        </div>
