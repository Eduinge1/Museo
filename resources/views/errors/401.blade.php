...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .page-bg::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse at 30% 40%, rgba(58,134,255,0.22) 0%, transparent 55%), radial-gradient(ellipse at 75% 65%, rgba(131,56,236,0.2) 0%, transparent 55%); pointer-events: none; }
    ...
    .error-icon-wrap { width: 80px; height: 80px; background: linear-gradient(135deg, var(--accent-3), var(--accent-4)); border-radius: 22px; display: flex; align-items: center; justify-content: center; font-size: 2.2rem; color: #fff; margin: 0 auto 1.5rem; }
    .error-code-label { font-size: 0.7rem; font-weight: 500; letter-spacing: 4px; text-transform: uppercase; color: var(--accent-3); margin-bottom: 0.4rem; }
    ...
    .btn-primary { display: inline-flex; align-items: center; gap: 0.5rem; background: var(--accent-3); color: #fff; border-radius: 12px; padding: 0.85rem 2rem; font-size: 0.95rem; font-weight: 500; text-decoration: none; transition: background 0.2s; font-family: 'DM Sans', sans-serif; margin-right: 0.5rem; margin-bottom: 0.5rem; }
    .btn-primary:hover { background: #1f6fd4; color: #fff; }
  ...
  <div class="page-bg">
    <div class="error-card">
      ...
      <p class="error-sub">
        ...
        Tu sesión puede haber expirado o aún no tienes una cuenta.
      </p>
      ...
      <p class="error-hint">¿No tienes cuenta? <a href="{{ route('register') }}">Regístrate gratis</a></p>
