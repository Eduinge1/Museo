...
<head>
  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    .page-bg::before { content: ''; position: absolute; inset: 0; background: radial-gradient(ellipse at 25% 35%, rgba(255,190,11,0.2) 0%, transparent 55%), radial-gradient(ellipse at 75% 65%, rgba(255,77,109,0.15) 0%, transparent 55%); pointer-events: none; }
    ...
    .error-icon-wrap { width: 80px; height: 80px; background: linear-gradient(135deg, var(--accent-2), #ff9500); border-radius: 22px; display: flex; align-items: center; justify-content: center; font-size: 2.2rem; color: #fff; margin: 0 auto 1.5rem; }
    .error-code-label { font-size: 0.7rem; font-weight: 500; letter-spacing: 4px; text-transform: uppercase; color: #d4960a; margin-bottom: 0.4rem; }
  ...
  <div class="page-bg">
    <div class="error-card">
      ...
      <p class="error-sub">
        ...
        Recarga la página para continuar desde donde estabas.
      </p>
      ...
      <p class="error-hint">Este error ocurre cuando la página lleva mucho tiempo abierta sin actividad.</p>
